...
@section('leveler')
    ...
    <li class="active"><i class="fa fa-dashboard"></i> {{ trans('message.create') }}</li>
@endsection
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            {!! Form::select('titular_id', $titulares, null, ["class"=>"form-control", "placeholder"=>"Seleccione un titular"]) !!}
                        </div>
                        <div class="col-md-6">
                            {!! Form::label('dominio','Dominio') !!}
                            {!! Form::text('dominio', null, ["class"=>"form-control", "placeholder"=>"Dominio"]) !!}
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            ...
                            {!! Form::select('modelo_id', [], null, ["class"=>"form-control", 'placeholder' => 'Seleccione un modelo']) !!}
                        </div>
                        <div class="col-md-2">
                            {!! Form::label('año','Año') !!}
                            {!! Form::number('año', null, ["class"=>"form-control", "placeholder"=>"Año"]) !!}
                        </div>
                    </div>
                </div>
