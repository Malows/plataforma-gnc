...
@section('contentheader_description','Agregar un nuevo trabajo')
    ...
    <div class="container-fluid spark-screen">
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                {!! Form::open(['route' => 'trabajos_de_taller.store', 'method' => 'POST']) !!}
                <div class="form-group">
                    <div class="col-md-6">
                        {!! Form::label('titular', 'Nombre del titular') !!}
                        {!! Form::select('titular', $titulares, null, ['placeholder' => 'Seleccione un titular', 'class' => 'form-control']) !!}
                    </div>
                    <div class="col-md-6">
                        {!! Form::label('vehiculo_id', 'Vehiculo') !!}
                        {!! Form::select('vehiculo_id', [], null, ['placeholder' => 'Seleccione un vehículo', 'class' => 'form-control']) !!}
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-6">
                        {!! Form::label('servicio_de_taller_id', 'Servicio') !!}
                        {!! Form::select('servicio_de_taller_id', $servicios, null, ['placeholder' => 'Ingrese un servicio', 'class' => 'form-control']) !!}
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('fecha_de_turno', null, ['placeholder' => 'YYYY-MM-DD hh:mm:ss', 'class' => 'form-control']) !!}
                        </div>
                    </div>
                </div>
                <div class="container-fluid">
                    <div class="form-group">
                        {!! Form::label('ingresado', 'Ingresado') !!}
                        {!! Form::checkbox('ingresado', "ingresado", true, ['class' => 'checkbox']) !!}
                    </div>
                    <div class="form-group">
